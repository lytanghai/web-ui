    ...
    <div class="expense-report">
      ...
      <section class="filter-section">
        ...
        <div class="filter-option">
          ...
          <input type="date" v-if="selectedOption === 'specific'" v-model="specificDate" style="width: fit-content;" />
        </div>
        ...
        <div class="filter-option">
          ...
          <div v-if="selectedOption === 'range'" class="range-inputs">
            <input type="date" style="width: fit-content;" v-model="rangeStartDate" @change="validateRange" />
...
async function applyFilter(page = 0) {
  ...
  try {
    ...
    if (error.response && error.response.status === 403) {
      ...
      alert('An error occurred while fetching profits.')
    }
  } finally {
    isLoading.value = false
  }
