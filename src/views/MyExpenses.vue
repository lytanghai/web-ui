    ...
    <div class="modal-overlay" @click.self="close">
        <div class="modal-content" @click.stop>
            <div class="modal-header">
                <h1></h1>
                <h2 style="text-decoration: underline;">My Expenses</h2>
            ...
            <table class="expense-table">
                ...
                <tbody>
                    <tr v-for="expense in expenses" :key="expense.id">
                        ...
                        <td>
                            <span v-if="expense.note && expense.note.length <= 30">{{ expense.note }}</span>
                            <span v-else-if="expense.note">
                                {{ expense.note.slice(0, 30) }}...
                                <button class="view-note-btn" @click="viewFullNote(expense.note)">
                                    View
                                </button>
                            </span>
                            <span v-else>-</span>
        ...
        <UpdateExpense v-if="showUpdateModal" :expense="selectedExpense" @updated="onExpenseUpdated"
...
function onExpenseUpdated(updatedExpense) {
...
@media screen and (max-width: 480px) {
    ...
    /* Filter form inputs stacked vertically */
    .filter-form {
        flex-direction: column;
    }
    ...
    /* Expense table converted to card style */
    .expense-table {
        display: block;
    }
